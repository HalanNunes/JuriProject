...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    ...
    <script src="/JuriProject/resources/js/mask/jquery.mask.min.js" type="text/javascript"></script>
    <!-- END JavaScript -->
                ...
                <div class="nav-collapse collapse">
                    <ul class="nav">
                        ...
                        <li class="dropdown divider-vertical">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Advogado <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="/JuriProject/advogado/novo">Adicionar</a></li>
                                <li><a href="/JuriProject/advogado/lista">Listar</a></li>
                            </ul>
                        </li>
                        <li class="dropdown divider-vertical">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Clientes <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="/JuriProject/cliente/novo">Adicionar</a></li>
                                <li><a href="/JuriProject/cliente/lista">Listar</a></li>
                            </ul>
                        </li>
                        <li class="dropdown divider-vertical">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">Processo <b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                <li><a href="/JuriProject/processo/novo">Adicionar</a></li>
                                <li><a href="/JuriProject/processo/lista">Listar</a></li>
                            </ul>
                        </li>

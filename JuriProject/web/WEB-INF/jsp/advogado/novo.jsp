...
<html>
    <head>
        <title>Adicionar Advogado</title>
    ...
    <body>
        ...
        <form:form action="novo" method="post" commandName="advogado" id="formulario_principal">
            <h1 style='margin-top: 50px;'>Novo Advogado</h1>
            <label>Nome:</label>
            ...
            <form:input path="registroOAB" required="required" placeholder="Nº do Registro OAB"/> *
            ...
            <form:input path="login" required="required" placeholder="Nome de Usuário"/> *

            <label>Senha:</label>
            <form:password path="senha" required="required" placeholder="Senha"/> *
